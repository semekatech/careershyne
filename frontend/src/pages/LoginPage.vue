...
// other imports like auth, router, $toast, LoginService, route if used
...
const handleLogin = async () => {
  ...
  try {
    ...
    if (user.role === 'promoter' && data.profile_complete === false) {
      $toast.warning("Please update your profile to at least 90% completion.", {
        position: "top-right",
      });
