    ...
    <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
      <div class="mb-4">
        ...
        >
          ...
          >
            We're here to help you grow your brand or connect with opportunities
            in Kenya and beyond.
          </p>
        </div>
      </div>
        ...
        <div class="grid md:grid-cols-2">
          ...
          <div class="h-full pr-6">
            <p class="mt-3 mb-12 text-lg text-gray-600 dark:text-slate-400">
              Reach out to us for collaborations, support, or just to say hello.
              ...
              <li class="flex">
                ...
                <div class="ml-4 mb-4">
                  ...
                  <p class="text-gray-600 dark:text-slate-400">
                    Valley View Office Nairobi, Kenya 00200
                  </p>
                  <p class="text-gray-600 dark:text-slate-400">
                    Nairobi, Kenya
                  </p>
