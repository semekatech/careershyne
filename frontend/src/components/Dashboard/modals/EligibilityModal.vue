      ...
      <div class="flex-1 p-6 overflow-y-auto">
        ...
        <div v-if="!result || progress < 100" class="flex flex-col items-center justify-center h-full text-center space-y-4">
          <p class="text-gray-600 text-lg font-medium">
            Comparing your CV with <strong>{{ job?.title }}</strong><span class="inline-block animate-pulse">...</span>
          </p>
...
const messages = [
  ...
  { text: "Checking skills...", color: "linear-gradient(to right, #a78bfa, #f472b6)" },
  { text: "Comparing job requirements...", color: "linear-gradient(to right, #facc15, #f97316)" },
  { text: "Finalizing match score...", color: "linear-gradient(to right, #34d399, #10b981)" },
];
