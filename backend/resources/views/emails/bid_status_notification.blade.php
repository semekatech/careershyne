...
<head>
    ...
    <title>Bid Status Notification</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 20px; line-height: 1.6; color: #333333;">
                            ...
                            <p style="margin-bottom: 15px;">
                                Your bid for the campaign <strong>{{ $bid->campaign_title }}</strong> has been
                                <strong
                                  style="color: {{ $bid->status === 'approved' ? '#28a745' : ($bid->status === 'rejected' ? '#dc3545' : '#ffc107') }};">
                                  {{ ucfirst($bid->status) }}
                                </strong>.
                            </p>
                            ...
                            <p style="margin-bottom: 15px;">
                                Congratulations! Your bid has been accepted. The campaign owner will contact you soon.
                            </p>
                            @elseif ($bid->status === 'rejected')
                            <p style="margin-bottom: 15px;">
                                Unfortunately, your bid was not successful this time. Feel free to reach out for more info.
                            </p>
                            @else
                            <p style="margin-bottom: 15px;">
                                Your bid status is currently: <strong>{{ ucfirst($bid->status) }}</strong>.
                            </p>
                            @endif


                            <p style="margin-bottom: 15px;">
                                If you have any questions, please <a href="mailto:support@yourcompany.com"
                                    style="color: #007bff; text-decoration: none;">contact us</a>.
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td align="center"
                            ...
                            <p style="margin: 0; line-height: 1.5;">Best regards,<br />The Team at Brandmax Media
                                Solutions</p>
                            ...
                            <p style="margin: 10px 0 5px 0;">&copy; {{ date('Y') }} Brandmax Media Solutions. All rights
                                reserved.</p>
