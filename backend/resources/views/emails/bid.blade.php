                    ...
                    <tr>
                        ...
                        <td style="padding: 20px; line-height: 1.6; color: #333333;">
                            <h2 style="color: #1a1a1a; font-size: 24px; margin-bottom: 10px;">Hi,
                                {{  $user->name }}!</h2>
                            <p style="margin-bottom: 15px;">Thank you for your interest in working with <b>{{ $campaign->brand }}</b>  for the <b>{{ $campaign->title }}</b>. Your expression of interest is pending approval. We will keep you updated.
                              </p>
